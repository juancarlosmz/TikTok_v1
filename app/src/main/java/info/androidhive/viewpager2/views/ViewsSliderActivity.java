...
public class ViewsSliderActivity extends AppCompatActivity {
    ...
    private void init() {
/*
        String path1="https://apolomultimedia-server4.info/videos/1.mp4";
        Uri uri=Uri.parse(path1);
        VideoView video=(VideoView)findViewById(R.id.videoViewapollo);
...
/*
        ...
        LinearLayout llMain2 = findViewById(R.id.rlMain2);
        VideoView esteVideo = new VideoView(this);
        String path1="https://apolomultimedia-server4.info/videos/1.mp4";
        Uri uri=Uri.parse(path1);
        esteVideo.setVideoURI(uri);
        LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.MATCH_PARENT
        );
        esteVideo.setLayoutParams(params2);
        esteVideo.start();
        llMain2.addView(esteVideo);
*/
